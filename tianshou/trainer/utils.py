...
def gather_info(start_time, train_c, test_c, best_reward):
    ...
    model_time = duration - train_c._collect_time - test_c._collect_time
    train_speed = train_c._collect_step / (duration - test_c._collect_time)
    test_speed = test_c._collect_step / test_c._collect_time
    return {
        'train_step': train_c._collect_step,
        'train_episode': train_c._collect_episode,
        'train_time/collector': f'{train_c._collect_time:.2f}s',
        'train_time/model': f'{model_time:.2f}s',
        'train_speed': f'{train_speed:.2f} step/s',
        'test_step': test_c._collect_step,
        'test_episode': test_c._collect_episode,
        'test_time': f'{test_c._collect_time:.2f}s',
